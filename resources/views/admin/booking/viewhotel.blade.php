...
@section('heading')
    ...
    <div class="col-md-12 align-self-center">
        <div class="text-center pull-right" style="margin-top: -28px;" >
            <a href="{{ url('admin/booking/addhotel') }}" ><button type="button" class="btn btn-success">Add Hotels</button></a>
        </div>
    </div>
@endsection
        ...
        <table class="table table-hover">
            ...
            @foreach($data as $datas)
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('admin.destroy_hotel', $datas->id) }}" method="POST">
                            {{ csrf_field() }}

                            <input type="hidden" name="_method" value="DELETE">

                            <a href="{{route('admin.edit_hotel',$datas->id)}}" class="btn btn-info"><i class="fa fa-pencil"></i></a>
