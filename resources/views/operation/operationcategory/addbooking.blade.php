...
@section('heading')
    ...
    <div class="col-md-12 align-self-center">
        <div class="text-center pull-right" style="margin-top: -28px;" >
            <a href="{{ url('operation/operationcategory/viewbooking') }}" ><button type="button" class="btn btn-success">View Booking</button></a>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <form id="regForm" action="{{ route('operation.showBooking') }}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
        <div class="item">
            <div class="container">
            ...
            <div class="row">
                ...
                {{--<label class="control-label" for="name">ROE</label>--}}
                {{--<input id="INR" name="guestname" type="text" placeholder="INR"  class="form-control"  onchange="inrfunc()" >--}}
                {{--</div>--}}
                {{--</div>--}}
                ...
                {{--<input id="USD" name="guestname" type="text" placeholder="USD" class="form-control"  onchange="usdfunc()" >--}}
                {{--</div>--}}
                {{--</div>--}}
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="form-group">
                        ...
                        <input id="" name="booking_given_by" type="text" placeholder="Booking GivenBy" class="form-control" required>
                    </div>
                </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input id="pick_date"  type="text" class="form-control datepicker-11" name="checkin" onchange="cal()" placeholder="mm/dd/yyyy" required>
                            <div class="input-group-append">
                                <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                            </div>
                        </div><!-- input-group -->
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input   id="drop_date"  type="text" class="form-control datepicker-11"  name="checkout" onchange="cal()" placeholder="mm/dd/yyyy" required>
                            <div class="input-group-append">
                                <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                            </div>
                        </div><!-- input-group -->
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="form-group item">
                        ...
                        <input id="noofroomnights" name="no_of_roomnights" type="text" placeholder="No Of RoomNights" class="form-control calculate_value" onchange="cal()" required>
                ...
                <div class="col-xl-12 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="tariff_perday" placeholder="Tariff Per Day" id="tariffValue" class="form-control calculate_value" required >
                    </div>
                </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="taxamount" placeholder="Tax Amount" id="taxamount"  class="form-control calculate_value" >
                    </div>
                </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="form-group ">
                        ...
                        <input type="text" name="total_with_tax" placeholder="Tariff with Tax" id="taxtariff"  class="form-control calculate_value" required>
                    </div>
                </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" id="commission_percentage_div" >
                    <div class="form-group row" id="percentage">
                        ...
                        <input type="number" id="commission_percentage" name="commission_percentage" min="0" placeholder="Amount"  class="form-control calculate_value">&nbsp;
                    </div>
                </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="form-group">
                        ...
                        <input  id="netAmount"  name="netamount" type="text" placeholder="Total Amount"  class="form-control" required>
                    </div>
                </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12"  id="commission_percentage_amount_div">
                    <div class="form-group row" id="percentage">
                        ...
                        <input type="number" id="commission_percentage_amount" name="commission_percentage_amount" step="0.01" min="0" placeholder="Amount"  class="form-control calculate_value" >
                    </div>
                </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                    <div class="form-group">
                        ...
                        <input  id="netcommission" name="kaia_commission" type="text" placeholder="Total Amount"  class="form-control calculate_value" required>
                    </div>
                </div>
