...
@section('heading')
    ...
    <div class="col-md-12 align-self-center">
        <div class="text-center pull-right" style="margin-top: -28px;" >
            <a href="{{ url('operation/operationcategory/viewhotel') }}" ><button type="button" class="btn btn-success">View Hotels</button></a>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <form id="regForm" action="{{ route('operation.showHotel') }}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="form-group">
                    ...
                    <input id="name" type="text" placeholder="Hotel Name" name="hotelname"  onkeypress="return onlyAlphabets(event,this);"  class="form-control" required>
                </div>
            </div>
            ...
            <div class="col-xl-12     col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="form-group">
                    ...
                    <input type="text" placeholder="Vendor" name="vendor"  class="form-control" required>
                </div>
            </div>
