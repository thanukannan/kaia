...
@section('content')
    ...
    <form id="regForm" action="{{route('operation.update_booking',$bookedData->id)}}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
    ...
    <script>
        $(document).ready(function () {
            ...
            $(window).on("load", function () {
                ...
                var roomType = '<?php echo $bookedData->roomtype ?>';
                $("#Roomtype option:selected").val(roomType);
