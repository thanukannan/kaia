...
@section('content')
    ...
    <form id="regForm"  action="{{route('operation.update_hotel',$data->id)}}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
        ...
        <div class="row">
            ...
            <div class="col-xl-12  col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="form-group">
                    ...
                    <input type="text" placeholder="Vendor"  value="{{ $data->vendor}}" name="vendor"  class="form-control" required>
                </div>
            </div>
